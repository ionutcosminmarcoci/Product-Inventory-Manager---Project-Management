...
insert  into `itemlist2`(`id`,`itemname`,`quantity`,`price`,`category`) values (4,'Xbox Controller','70','50','Electronics'),(5,'Apple 1KG','50','1','Grocery'),(6,'Watermelon','99','2','Grocery'),(8,'Jeans-Medium','35','15','Clothing'),(9,'T-Shirts','99','7','Clothing'),(10,'Onion 1KG','50','1','Grocery'),(11,'PS5','10','449','Electronics'),(12,'Mechanical-Pencil','20','12','Stationary');
...
insert  into `seller`(`id`,`name`,`password`,`email`) values (1,'seller','seller','gmail');
...
insert  into `user`(`id`,`name`,`password`,`email`) values (1,'abc','abc','abc'),(2,'abc2','abc2','abc2'),(3,'admin','admin','admin'),(4,'user','user','@gmail');
